...
<p align="center">
    ...
    <a href="https://github.com/xiehqing/hiagent/releases"><img src="https://img.shields.io/github/release/charmbracelet/crush" alt="Latest Release"></a>
    <a href="https://github.com/xiehqing/hiagent/actions"><img src="https://github.com/xiehqing/hiagent/actions/workflows/build.yml/badge.svg" alt="Build Status"></a>
</p>
...
[releases]: https://github.com/xiehqing/hiagent/releases

Or just install it with Go:

```
go install github.com/xiehqing/hiagent@latest
```
...
Details on exactly what’s collected are in the source code ([here](https://github.com/xiehqing/hiagent/tree/main/internal/event)
and [here](https://github.com/xiehqing/hiagent/blob/main/internal/llm/agent/event.go)).
...
See the [contributing guide](https://github.com/xiehqing/hiagent?tab=contributing-ov-file#contributing).
...
[FSL-1.1-MIT](https://github.com/xiehqing/hiagent/raw/main/LICENSE.md)
