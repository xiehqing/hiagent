...
import (
	...
	hyperp "github.com/xiehqing/hiagent/internal/agent/hyper"
	...
	"github.com/xiehqing/hiagent/internal/oauth/hyper"
)
...
func (s *ConfigStore) SetRuntimePreferredModel(provider string, model string) error {
	...
	if m == nil {
		return fmt.Errorf("SetRuntimePreferredModel: model %s/%s not found", provider, model)
	}
