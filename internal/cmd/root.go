...
import (
	...
	"github.com/xiehqing/hiagent/internal/client"
	"github.com/xiehqing/hiagent/internal/config"
	"github.com/xiehqing/hiagent/internal/db"
	"github.com/xiehqing/hiagent/internal/event"
	crushlog "github.com/xiehqing/hiagent/internal/log"
	"github.com/xiehqing/hiagent/internal/projects"
	"github.com/xiehqing/hiagent/internal/proto"
	"github.com/xiehqing/hiagent/internal/server"
	"github.com/xiehqing/hiagent/internal/session"
	"github.com/xiehqing/hiagent/internal/ui/common"
	ui "github.com/xiehqing/hiagent/internal/ui/model"
  ...
  `,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if _, err := program.Run(); err != nil {
			...
			return errors.New("Crush crashed. If metrics are enabled, we were notified about it. If you'd like to report it, please copy the stacktrace above and open an issue at https://github.com/xiehqing/hiagent/issues/new?template=bug.yml") //nolint:staticcheck
		}
		return nil
	},
}
