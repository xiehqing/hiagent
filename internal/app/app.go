...
import (
	...
	"github.com/xiehqing/hiagent/internal/format"
	...
	"github.com/xiehqing/hiagent/internal/shell"
	...
	"github.com/xiehqing/hiagent/internal/update"
...
func (app *App) GetDefaultSmallModel(providerID string) config.SelectedModel {
	...
	knownProviders, _ := config.KnownProviders(app.config.Config(), app.config.Conn())
